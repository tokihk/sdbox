...
#define NETC_EP_FRAME_SIZE_MAX			1522U
...
#define NETC_EP0_RXBD_NUM				32U
#define NETC_EP0_RXFRAME_NUM			32U

#define NETC_EP0_TXBD_NUM				16U
...
/** RX DMA バッファプール */
AT_NONCACHEABLE_SECTION_ALIGN(static uint8_t		s_rx_bufs[NETC_EP0_RXFRAME_NUM][NETC_EP_FRAME_SIZE_MAX], NETC_EP_BUFF_SIZE_ALIGN);

/** TX BD リング用バッファ（SDKが要求するアライメント） */
AT_NONCACHEABLE_SECTION_ALIGN(static netc_tx_bd_t	s_tx_bds[NETC_HAL_TX_BD_NUM], NETC_EP_BD_ALIGN);

/** RX BD リング用バッファ */
AT_NONCACHEABLE_SECTION_ALIGN(static netc_rx_bd_t	s_rx_bds[NETC_HAL_RX_BD_NUM], NETC_EP_BD_ALIGN);
